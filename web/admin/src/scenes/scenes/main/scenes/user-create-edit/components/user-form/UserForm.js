...
import { Form, Input, Switch, Button, Checkbox, Icon } from "antd";
...
class UserForm extends Component {
  ...
  renderNameField({ getFieldDecorator }) {
    return (
      <Form.Item hasFeedback label="Name" {...this.formItemLayout}>
  ...
  renderEmailField({ getFieldDecorator }) {
    return (
      <Form.Item hasFeedback label="Email" {...this.formItemLayout}>
  ...
  renderUpdatePasswordField({ getFieldDecorator }) {
    return (
      <Form.Item label="Update password" {...this.formItemLayout}>
  ...
  renderPasswordField({ getFieldDecorator, getFieldValue }) {
    ...
    return (
      <Form.Item hasFeedback label="Password" {...this.formItemLayout}>
  ...
  renderIsActivatedField({ getFieldDecorator, getFieldValue }) {
    return (
      <Form.Item label="Activated" {...this.formItemLayout}>
  ...
  renderExtraField({ getFieldDecorator }) {
    ...
    return (
      <Form.Item hasFeedback label="Extra" {...this.formItemLayout}>
  ...
  renderSubmitButton({ isFieldTouched, getFieldValue, getFieldsError }) {
    ...
    for (let field of required) {
      requiredIsTouched =
        requiredIsTouched && (isFieldTouched(field) || getFieldValue(field));
    }
  ...
  render() {
    ...
    return (
      <Form onSubmit={this.handleSubmit}>
        ...
        {isEdit ? this.renderUpdatePasswordField(form) : null}
